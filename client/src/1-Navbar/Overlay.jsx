...
function Overlay1() {
  ...
  return (
    <>
      <Button style={{backgroundColor:'#232f3e', borderColor:'transparent'}} onClick={handleShow}>
        <RxHamburgerMenu/> All
      </Button>

      <Offcanvas show={show} onHide={handleClose}>
        <Offcanvas.Header style={{backgroundColor:'#232f3e', color:'white'}} closeButton>
          <Offcanvas.Title> <BsPersonCircle/> Hello, Sign in </Offcanvas.Title>
        </Offcanvas.Header>
        <Offcanvas.Body>
           <h5 className='h5-a' style={{color:'black', fontSize:'18px', fontWeight:'300'}}>Trending</h5>
