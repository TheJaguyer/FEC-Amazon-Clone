...
will be at your beck and call.',
  ...
  (
    ...
    'Yes, it is compatible with bluetooth capabilities.',
    1,
    CURRENT_TIMESTAMP,
    2
  ),
...
the correct buttons in the correct order, and world peace is guaranteed.',
    1,
    CURRENT_TIMESTAMP,
    5
  ),
  (
    ...
    'The weight is 2 lbs, its a thicc boy.',
    1,
    CURRENT_TIMESTAMP,
    3
  );